...
let addresses = [
	//'8.210.89.245:2096#FRY-HK',
	
];

// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/TontFeng/ip/main/fryip.txt',
...
let CMproxyIPs = [
	//'proxyip.hk.fxxk.dedyn.io:HK',//匹配节点名, 有HK就分配该ProxyIP域名
	'proxyip.hk.hw.090227.xyz:HK-FRY',
	'proxyip.jp.fxxk.dedyn.io:JP-FRY',
	'34.82.76.253:US-FRY',
	'cdn-all.xn--b6gac.eu.org:SG-FRY',
	'proxyip.kr.fxxk.dedyn.io:KR-FRY',
]
